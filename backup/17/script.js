...
{
  realColors = JSON.parse(localStorage.getItem("realColors"));
}
...
function save()
{
  localStorage.setItem("realColors", JSON.stringify(realColors));
