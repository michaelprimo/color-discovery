...
let nameColors = ['lavandaebczf', 'magentahrkzp','rosabcdfytp','melanzanawkj','troncoiulpea','castagnombvc','angurialpoiy','salmonebczxw','aragostawzxdf','coralloebckp','azaleadcbkg','ciliegiakpouy','rossohjklgfd','bordeauxwaz','platinofghjk','conchigliasd','granotyfeuil','pescahjklfdx','arancioneuyt','oroaeiuptkjz','moganoertyvb','avorioeuvpjh','beigeauiyxzf','albicoccaute','carbonehfdsx','rame','zafferano','cioccolato','limone','giallo','verde','acquamarina','giada','antracite','ardesio','celeste','azzurro','blu','lilla','glicine','orchidea','ametista','viola','indaco','prugna','grigio','nero','ciano'];
...
function letterSelectedmax()
{
  ...
  letterSelected.style.width = "" + 50 * realColors[level].length + "px";
}
